...
run: async (bot, message, args) => { //async
      ...
      message.react('887650847327158343');
                ...
                .setTitle(`About Me`)
                .setThumbnail(message.guild.iconURL({ dynamic: true }))
                .setDescription(`**Sono Stato Creato da, \`PippoBaudo#5601\`!\n\n**`)
                .setColor(`#0x2F3136`)
        ...
        .setValue('option1')
        .setEmoji("🏠")
        .setDescription('Vedi tutti i comandi')

        let option2 = new MessageMenuOption()
        .setLabel('Commands')
        .setValue('option2')
        .setEmoji("🎫")
        .setDescription('Vedi i comandi premium')

        let option3 = new MessageMenuOption()
        .setLabel('Features')
        .setValue('option3')
        .setEmoji("❓")
        .setDescription('Vedi i poteri premium')
  
      let option4 = new MessageMenuOption()
        .setLabel('About Me')
        .setValue('option4')
        .setEmoji("📔")
        .setDescription('Su di me')
 ...
 b.reply.defer();
    ...
    collector.on("end", (b) => {
        ...
        .setFooter("Powered by PippoBaudo#5601"))
    })
